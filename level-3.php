        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <br>
                    <p class="text-xl penjelasan text-teal-600">Te<i>k</i>nik <i>:</i> <span
                            class="text-teal-100">Information
                            Gathering</span></p>
                    <p class="text-xl penjelasan text-teal-600">Petun<i>j</i>uk : <span
                            class="text-teal-100"><i>V</i>iew Page
                            <i>S</i>ource</span></p>
...
if ( isset($_POST["submit"]) ) {
   ...
   if ( $_POST["username"] == $username ) {
    $_SESSION["level-3.php"] = true;
    header("Location: level-4.php");
    exit;
    echo "<script>
    Swal.fire({ title: `Good`,
                text: `Your username and password are correct!`, 
                icon: `success`,
                footer: `<a href='level-4' style='color: #0c1220; background-color: aqua;' class='btn btn-primary'>Continue</a>`,
                 });
