      ...
      if (isset($_POST['generate'])) {
        ...
        if ( $nama == "" ) {
          ...
          <div class='alert alert-success col-sm-6' role='alert'>
              Yayyy! selamat $nama, kamu sudah mendapat sertifikat dan sudah pantas bergabung dengan grup khusus kamiii 
              <a href='https://chat.whatsapp.com/CNt1dCCd1FcKkDcOQku6kH' class='btn btn-success'>Join our Special Group</a>
          </div>
          ";
          ...
          // nama file teks nya 
          $drFont = dirname(__FILE__) ."/font/college.ttf";
